...
if (file_exists('PHPMailer/PHPMailer.php') && file_exists('PHPMailer/SMTP.php') && file_exists('PHPMailer/Exception.php')) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $phpmailer_loaded) {
  $name = $_POST["name"];
  $email = $_POST["email"];
...
} elseif ($_SERVER["REQUEST_METHOD"] == "POST" && !$phpmailer_loaded) {
  $error_message = "Email functionality is temporarily unavailable. Please contact us directly.";
}
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets2/img/hero-img.svg" class="img-fluid animated-image" alt="hero-image">
        </div>
      </div>
    </div>
