(function ($) {
    ...
    function date_click(event) {
        ...
        $(".table-date").removeClass("selected-date");
        
        // Add selection to current date
        $(event.currentTarget).addClass("selected-date");
        
        var day = event.currentTarget.textContent;
        ...
        // Store selected date for form submission
        window.selectedDate = {
            day: day,
            month: month,
            year: year,
        ...
        // Show the dialog when a date is clicked
        $("#dialog").show(250);
    }
